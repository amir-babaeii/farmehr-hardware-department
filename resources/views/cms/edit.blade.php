                ...
                <form id="myForm" style="text-align:left;" method="POST" dir="rtl" action="/edit/{{$data->id}}">
                        ...
                        <div class="row py-3">
                            ...
                            <div class="form-group row col-lg-6 ">
                                ...
                                <div class="col-lg-8">
                                    <textarea id="truble" style="min-height: 100px" class="form-control @error('truble') is-invalid @enderror" name="truble" value="{{ $data->truble }}"  autocomplete="truble" autofocus></textarea>
                                </div>
                            </div>
                            <div class="form-group row col-lg-6 ">
                        ...
                        <div class="row pb-3">
                         ...
                         <div class="row py-3">
                            <div class="form-group row col-lg-6 ">
                                ...
                                <div class="col-lg-9">
                                    <input id="get_date" type="datetime"  step="1" class="form-control @error('get_date') is-invalid @enderror" name="get_date" value="{{ $data->get_date }}"  autocomplete="get_date" autofocus disabled></textarea>
                                </div>
                            </div>
                            <div class="form-group row col-lg-6">
                                ...
                                <div class="col-lg-9">
                                    <input id="out_date" type="datetime"  step="1" class="form-control @error('out_date') is-invalid @enderror" name="out_date" value="{{ $data->out_date }}"  autocomplete="out_date" autofocus disabled></textarea>
                                </div>
                            </div>
                         </div>
                         <div class="form-group row col-lg-12 ">
                        ...
                        <div class="form-group row col-lg-12 ">
                         ...
                         <div class="row py-4 " dir="ltr" >
                            <button type="submit"  name="submit" class="btn btn-success  col-lg-2">ویرایش</button>
